  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (clubLogoFile) {
        ...
        const storageRef = ref(storage, `club_logos/registration_${Date.now()}`);
          ...
          <div className="space-y-4">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <p className="text-sm text-yellow-800">
                <strong>Note:</strong> Your account will need admin verification before you can create events.
              </p>
            </div>
          </div>
